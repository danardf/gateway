                            ...
                            <form class="fpbx-submit" method="post" action="?display=gateway">
                                <div class="col-md-12 mybox">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" pattern="[a-zA-Z0-9éèçàùô_\s\-]+" required id="contact" name="contact" class="form-control" aria-label="contact" placeholder="<?= _("Enter the name of the contact.") ?>">
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                        ...
                                        <input type="description" pattern="[a-zA-Z0-9éèçàùô_\s\-]+" id="description" name="description" class="form-control" aria-label="description" placeholder="<?= _("Enter the description of the gateway.") ?>">
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" pattern="[a-zA-Z0-9éèçàùô_\s\-]+" id="address" name="address" class="form-control" aria-label="name" placeholder="<?= _("Enter the address of the contact.") ?>">
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                        ...
                                        <input type="text" pattern="\d{5}" id="zip" name="zip" class="form-control" aria-label="zip" placeholder="<?= _("Enter the ZIP code.") ?>">
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                        ...
                                        <input type="text" pattern="[a-zA-Z0-9éèçàùô_\s\-]+" id="city" name="city" class="form-control" aria-label="city" placeholder="<?= _("Enter the city of the contact.") ?>">
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                        ...
                                        <input type="text" pattern="[a-zA-Zéèçàùô_\s\-]+" id="country" name="country" class="form-control" aria-label="country" placeholder="<?= _("Enter the country of the contact.") ?>">
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        <span class="input-group-addon">
