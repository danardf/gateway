                                ...
                                <form class="fpbx-submit" method="post" action="?display=gateway">
                                    <div class="col-md-12 mybox">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" pattern="[a-zA-Z0-9_\s\-]+" required id="contact" name="contact" class="form-control" aria-label="contact" value="<?= $gateway["contact"] ?>" placeholder="<?= _("Enter the name of the contact.") ?>">
                                        </div>
                                        <br>
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                            ...
                                            <input type="description" pattern="[a-zA-Z0-9_\s\-]+" id="" name="description" class="form-control" aria-label="description" value="<?= $gateway["description"] ?>"  placeholder="<?= _("Enter the description of the gateway.") ?>">
                                        </div>
                                        <br>
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" pattern="[a-zA-Z\d_\s\-]+" id="address" name="address" class="form-control" aria-label="name" value="<?= $gateway["address"] ?>" placeholder="<?= _("Enter the address") ?>">
                                        </div>
                                        <br>
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" pattern="[a-zA-Z0-9_\s\-]+" id="city" name="city" class="form-control" aria-label="city" value="<?= $gateway["city"] ?>"  placeholder="<?= _("Enter the city") ?>">
                                        </div>
                                        <br>
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                            ...
                                            <input type="text" pattern="[a-zA-Z0-9_\s\-]+" id="country" name="country" class="form-control" aria-label="country" value="<?= $gateway["country"] ?>"  placeholder="<?= _("Enter the country") ?>">
                                        </div>
                                        <br>
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="tel" required id="" name="dids[]" class="form-control" aria-label="primarydid" placeholder="<?= _("Primary DID number to afect on this gateway (Usualy the same as your extension number).") ?>" value="<?= $gateway["extension"] ?>" readonly="readonly">
                                        </div>
                                        ...
                                        <?php
                                            ...
                                            foreach($gateways as $index => $gtw){
                                                if($index != 0){
                                                    ...
                                                    $input .= _('DID').'&nbsp;<i class="fa fa-trash" id="delDid" title="'._('Delete it.').'"></i></span>';
                                                    $input .='</span>';
                                                    $input .='<input type="tel" required name="dids[]" class="form-control" aria-label="dids" value="'.$gtw.'" placeholder="'._("DID number to add on this gateway (only one entry).").'">';
                                                    $input .='</div>';
                                                    print($input);
                                                }
                                            }
